...
author: "李AA"
published: true
headerImage: "/img/post-bg-rock-climbing.jpg"
tags:
  - "C++"
  - "Wwise"
  - "Juce"
  - "Plugin"
slug: "wwise-plugin-development-procedure"
---
- [前言](#前言)
- [Juce](#juce)
	- [DSP](#dsp)
...
![](/img/in-post/WwisePluginDev/Juce/TestPlugin.png)

* 

![](/img/in-post/WwisePluginDev/Juce/PluginHostPath.png)
...
![](/img/in-post/WwisePluginDev/Premake/BuildType.png)

* 添加插件```创建描述```

![](/img/in-post/WwisePluginDev/Premake/Description.png)

* 生成文件

![](/img/in-post/WwisePluginDev/Premake/BasicGeneration.png)
...
![](/img/in-post/WwisePluginDev/Premake/BuildPlatform.png)

* 构建```目标平台```

![](/img/in-post/WwisePluginDev/Premake/Win_vc160TargetGenerated.png)

* 生成vc160项目

![](/img/in-post/WwisePluginDev/Premake/VC160_Solution.png)
...
![](/img/in-post/WwisePluginDev/Premake/BuildAuthoringError.png)

![](/img/in-post/WwisePluginDev/Premake/MFC.png)

* 模板工程同时生成AuthoringTools使用dll与Engine使用的lib文件，可以在工程中重新设置输出目录

![](/img/in-post/WwisePluginDev/Premake/AuthoringDLL.png)

![](/img/in-post/WwisePluginDev/Premake/EngineLib.png)

* Wwise工程中插入该插件以便后面进行测试

![](/img/in-post/WwisePluginDev/Premake/AuthoringFX.png)
...
* Wwise插件的调试我是使用```附加到进程```的方式，打开Wwise工程后VS端附加到进程上进行调试。这里要注意插件Debug版本构建配置的输出目录要设置到"Authoring/x64/Release/bin/Plugins"。AuthoringTools的插件加载目录是这个，或者手动复制过去也可以。
    ![](/img/in-post/WwisePluginDev/Wwise/SoundEngine/Debug.png)
...
![](/img/in-post/WwisePluginDev/Wwise/Authoring/Sources.png)
...
![](/img/in-post/WwisePluginDev/Wwise/Authoring/Panel.png)


### 接口实现

![](/img/in-post/WwisePluginDev/Wwise/Authoring/IAudioPlugin.png)
...
![](/img/in-post/WwisePluginDev/Wwise/SoundEngine/Sources.png)
...
![](/img/in-post/WwisePluginDev/Wwise/SoundEngine/IAkPlugin.png)
...
![](/img/in-post/WwisePluginDev/Wwise/SoundEngine/IAkPluginParam.png)
